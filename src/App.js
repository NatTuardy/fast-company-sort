      ...
      <>
        <div className="d-flex">
          ...
          <div className="d-flex flex-column">
            ...
            <UsersTable userCrop={userCrop} onSort={handleSort} currentSort={sortBy} onDelete={handleDelete} onToggle={handleToggleBookmark}/>
      ...
      {!users ? (
        <h4>
          <span className="badge m-2 h-12 bg-danger">
            Никто не тусанет с тобой сегодня</span>
        </h4>
      ) : (
        renderTable()
      )}
